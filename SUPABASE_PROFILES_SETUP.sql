...
INSERT INTO public.profiles (
  ...
  ('Eizziel Marie A.', 'Bacoy', 'eizzielmarie.bacoy@carsu.edu.ph', 'Feature Writer', 'Online Accounts Manager', 'writer', 'active', 'member'),
  ...
  ('Levi Brian C.', 'Cejuela', 'levibrian.cejuela@carsu.edu.ph', 'Photojournalist', NULL, 'artist', 'active', 'member'),
  ...
  ('Jonee R.', 'Elopre Jr.', 'jonee.elopre@carsu.edu.ph', 'News Writer', 'Managing Editor', 'writer', 'active', 'member'),
  ...
  ('Melede S.', 'Ganoy', 'melede.ganoy@carsu.edu.ph', 'News Writer', 'Feature Editor', 'writer', 'active', 'member'),
  ...
  ('Jules Leo M.', 'Reserva', 'julesleo.reserva@carsu.edu.ph', 'Videographer', NULL, 'artist', 'active', 'member'),
