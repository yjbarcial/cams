...
-- =====================================================
-- 12. User profiles are now created by Supabase Auth signup
-- =====================================================
-- Do not seed default organization members here. Accounts should appear only
-- after a real user signs up and is approved by a system administrator.
