...
-- Upsert profiles using positions_label and designation_label only
INSERT INTO public.profiles (
  ...
  role
    ...
    ('Lex Zyrreh Devonnaire D.', 'Abellanosa', 'lexzyrrehdevonnaire.abellanosa@carsu.edu.ph', 'Layout Artist', 'Senior Graphic Designer', 'active', 'member'),
    ('Teejay', 'Abello', 'teejay.abello@carsu.edu.ph', NULL, NULL, 'active', 'member'),
    ('Nissi Y.', 'Abes', 'nissi.abes@carsu.edu.ph', 'News Writer', 'Circulations Manager', 'active', 'member'),
    ('Belle Blanche Kyle C.', 'Abiol', 'belleblanchekyle.abiol@carsu.edu.ph', 'Illustrator', NULL, 'active', 'member'),
    ('Jessah Mei P.', 'Allard', 'jessahmei.allard@carsu.edu.ph', 'Layout Artist', 'Newsletter EIC', 'active', 'member'),
    ('John Ian M.', 'Alfaras', 'jonhian.alfaras@carsu.edu.ph', 'Videographer', NULL, 'active', 'member'),
    ('Lendon A.', 'Almocera', 'lendon.almocera@carsu.edu.ph', 'Videographer', NULL, 'active', 'member'),
    ('Eizziel Marie A.', 'Bacoy', 'eizzielmarie.bacoy@carsu.edu.ph', 'Feature Writer', 'Archival Manager', 'active', 'editor'),
    ('Nevlim', 'Baldelovar', 'nevlim.baldelovar@carsu.edu.ph', 'Literary Writer', 'Opinion Editor', 'active', 'member'),
    ('Robert Louis B.', 'Bebis', 'robertlouis.bebis@carsu.edu.ph', 'Illustrator', NULL, 'active', 'member'),
    ('Ryan Christian D.', 'Benignos', 'ryanchristianbenignos@carsu.edu.ph', NULL, NULL, 'active', 'member'),
    ('Sophija D.', 'Bentulan', 'sophija.bentulan@carsu.edu.ph', 'Sports Writer', NULL, 'active', 'member'),
    ('Fernando Gabriel P.', 'Bunio', NULL, 'Opinion Writer', NULL, 'active', 'member'),
    ('Peter Lorenzo', 'Calo', 'peterlorenzo.calo@carsu.edu.ph', 'Photojournalist', 'Creative Director', 'active', 'member'),
    ('Levi Brian C.', 'Cejuela', 'levibrian.cejuela@carsu.edu.ph', 'Photojournalist', 'Creative Director', 'active', 'editor'),
    ('Joshua C.', 'Coralde', 'joshuajosh.coralde@carsu.edu.ph', 'Opinion Writer', NULL, 'active', 'member'),
    ('Josefa T.', 'Cruzada', 'josefa.cruzada@carsu.edu.ph', NULL, NULL, 'active', 'member'),
    ('Lordelie S.', 'Darog', 'lordelie.darog@carsu.edu.ph', 'Feature Writer', NULL, 'active', 'member'),
    ('Jezwer B.', 'Delima', 'jezwer.delima@carsu.edu.ph', 'Feature Writer', NULL, 'active', 'member'),
    ('Jellan S.', 'Denonong', 'jellanaille.denonong@carsu.edu.ph', 'Literary Writer', 'Technical Editor', 'active', 'member'),
    ('Jonee R.', 'Elopre Jr.', 'jonee.elopre@carsu.edu.ph', 'News Writer', 'Technical Editor', 'active', 'editor'),
    ('Devorah Grace', 'Esguerra', 'devorahgrace.esguerra@carsu.edu.ph', 'Feature Writer', 'Senior Illustrator', 'active', 'member'),
    ('Rexter M.', 'Etang', 'rexter.etang@carsu.edu.ph', 'Illustrator', 'Sports Editor', 'active', 'member'),
    ('Jerby Claire M.', 'Factularin', 'jerbyclaire.factularin@carsu.edu.ph', 'Sports Writer', 'Editor-in-Chief', 'active', 'member'),
    ('Melede S.', 'Ganoy', 'melede.ganoy@carsu.edu.ph', 'News Writer', 'Editor-in-Chief', 'active', 'editor'),
    ('Jofred James L.', 'Gerasmio', 'jofredjames.gerasmio@carsu.edu.ph', 'Feature Writer', NULL, 'active', 'member'),
    ('Matt Andrew', 'Graban', 'mattandrew.graban@carsu.edu.ph', 'Photojournalist', 'HR Manager', 'active', 'member'),
    ('Hannah Faith A.', 'Labadan', 'hannahfaith.labadan@carsu.edu.ph', 'Illustrator', 'News Editor', 'active', 'member'),
    ('Megumi Erika O.', 'Labaja', 'megumierika.labaja@carsu.edu.ph', 'Sports Writer', NULL, 'active', 'member'),
    ('Anne E.', 'Lanzon', 'anne.lanzon@carsu.edu.ph', 'Photojournalist', NULL, 'active', 'member'),
    ('Gerza Allea L.', 'Lim', 'gerzaallea.lim@carsu.edu.ph', 'Layout Artist', NULL, 'active', 'member'),
    ('Jhon David M.', 'Lloren', 'jhondavid.lloren@carsu.edu.ph', 'Photojournalist', NULL, 'active', 'member'),
    ('Shieny Griethzer R.', 'Lozada', 'shienygriethzer.lozada@carsu.edu.ph', 'News Writer', NULL, 'active', 'member'),
    ('Samantha Jezette M.', 'Maestrado', 'samanthajezette.maestrado@carsu.edu.ph', 'Photojournalist', NULL, 'active', 'member'),
    ('Jaylor A.', 'Malnegro', 'jaylor.malnegro@carsu.edu.ph', 'Illustrator', NULL, 'active', 'member'),
    ('Ma. Julianny A.', 'Navarez', 'majulianny.navarez@carsu.edu.ph', 'Illustrator', NULL, 'active', 'member'),
    ('Edwin II', 'Mori', 'edwin.mori@carsu.edu.ph', 'Photojournalist', NULL, 'active', 'member'),
    ('Kaya Danielle L.', 'Nason', 'kayadanielle.nason@carsu.edu.ph', 'Literary Writer', NULL, 'active', 'member'),
    ('Mhegan S.', 'Niez', 'mhegan.niez@carsu.edu.ph', 'Layout Artist', NULL, 'active', 'member'),
    ('Kurt Clyde S.', 'Pablo', 'kurtclyde.pablo@carsu.edu.ph', 'Photojournalist', NULL, 'active', 'member'),
    ('Jhared Miguel S.', 'Paderna', 'jharedmiguel.paderna@carsu.edu.ph', 'Videographer', 'Online Accounts Manager', 'active', 'member'),
    ('Jevan M.', 'Racaza', 'jevan.racaza@carsu.edu.ph', 'Layout Artist', 'Associate Managing Editor', 'active', 'member'),
    ('Jules Leo M.', 'Reserva', 'julesleo.reserva@carsu.edu.ph', 'Videographer', 'Archival Manager', 'active', 'editor'),
    ('Glenn Ferdinan C.', 'Rojas', 'glennferdinan.rojas@carsu.edu.ph', 'Sports Writer', 'Senior Photojournalist', 'active', 'member'),
    ('Missi Vidka M.', 'Santillan', 'missividka.santillan@carsu.edu.ph', 'Opinion Writer', 'Literary Editor', 'active', 'member'),
    ('Elaine Pearl M.', 'Silagan', 'elainepearl.silagan@carsu.edu.ph', 'Photojournalist', 'Sr. Cinematographer', 'active', 'member'),
    ('Samuel Lhoide G.', 'Ursales', 'samuellhoide.ursales@carsu.edu.ph', 'Literary Writer', NULL, 'active', 'member'),
    ('Kent Adriane', 'Vinatero', 'kentadriane.vinatero@carsu.edu.ph', 'Videographer', 'Online Accounts Manager', 'active', 'editor')
ON CONFLICT (email) 
DO UPDATE SET
